...
inline double MAX_TIME_ALLOCATION_DIVISOR = 40;
inline double MAX_TIME_ALLOCATION_DIVISOR_MG = 40;
inline double MAX_TIME_ALLOCATION_DIVISOR_EG = 40;
...
inline double EXTRA_BEST_FLIP = 0;
inline double EXTRA_BEST_WEIGHT = 0;
