...
constexpr std::size_t RFP_SURPLUS_BUCKET_COUNT = 7;
constexpr std::size_t RFP_DEPTH_BUCKET_COUNT = 7;
...
enum class SearchDiagCounter : std::size_t {
    RfpAttempts,
    RfpCheapCandidates,
    RfpFullConfirmations,
    RfpFullRejections,
    RfpBandBypasses,
    RfpSurplusCandidate0To15,
    RfpSurplusCandidate16To31,
    RfpSurplusCandidate32To63,
    RfpSurplusCandidate64To127,
    RfpSurplusCandidate128To255,
    RfpSurplusCandidate256To511,
    RfpSurplusCandidate512Plus,
    RfpSurplusEvaluated0To15,
    RfpSurplusEvaluated16To31,
    RfpSurplusEvaluated32To63,
    RfpSurplusEvaluated64To127,
    RfpSurplusEvaluated128To255,
    RfpSurplusEvaluated256To511,
    RfpSurplusEvaluated512Plus,
    RfpSurplusReject0To15,
    RfpSurplusReject16To31,
    RfpSurplusReject32To63,
    RfpSurplusReject64To127,
    RfpSurplusReject128To255,
    RfpSurplusReject256To511,
    RfpSurplusReject512Plus,
    RfpDepthCandidate1,
    RfpDepthCandidate2,
    RfpDepthCandidate3,
    RfpDepthCandidate4,
    ...
    FutilityCheckGuards,
    FutilityCheckGuardExactChecks,
    FutilityCheckGuardFalsePositives,
    FutilityCheckGuardAlphaRaises,
    FutilityCheckGuardBetaCutoffs,
    FutilityPasserGuards,
    FutilityPasserGuardAlphaRaises,
    FutilityPasserGuardBetaCutoffs,
    FutilityPrunes,
    DangerousPasserMoves,
    LmrPasserGuards,
    LmrPasserReductionPliesSaved,
    LmrReductions,
    LmrResearches,
    LmrResearchImproved,
    PvsZeroWindowSearches,
    PvsFullWindowResearches,
    CheckExtensionDepth1Skipped,
    CheckExtensionsDepth2,
    CheckExtensionsDepth3,
    CheckExtensions,
