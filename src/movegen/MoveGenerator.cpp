...
inline void append_piece_moves(MoveList& moves, const Position& pos,
    ...
    Bitboard king_checking_squares) {
    ...
    if constexpr (!captures_only) {
        Bitboard quiets = possible_moves & ~enemy_pieces;
        while (quiets) {
        ...
        Bitboard quiet_checks = possible_moves & ~enemy_pieces
            & king_checking_squares;
        while (quiet_checks) {
...
void MoveGenerator::generate_queen_moves(MoveList& moves, const Position& pos, Color own_color, const Bitboard& pinned_info, Bitboard remedy_mask) {
    ...
    Bitboard king_checking_squares = 0;
    if constexpr (captures_only && with_checks) {
        king_checking_squares = queen_attacks(pos.get_king_square(other_color), occupied) & ~own_pieces;
    }
    ...
    while (queens) {
        ...
        append_piece_moves<captures_only, with_checks>(moves, pos, queen_sq,
            PieceType::Queen, own_color, other_color, possible_queen_moves,
            enemy_pieces, king_checking_squares);
    }
...
void MoveGenerator::generate_rook_moves(MoveList& moves, const Position& pos, Color own_color, const Bitboard& pinned_info, Bitboard remedy_mask) {
    ...
    Bitboard king_checking_squares = 0;
    if constexpr (captures_only && with_checks) {
        king_checking_squares = rook_attacks(pos.get_king_square(other_color), occupied) & ~own_pieces;
    }
    ...
    while (rooks) {
        ...
        append_piece_moves<captures_only, with_checks>(moves, pos, rook_sq,
            PieceType::Rook, own_color, other_color, possible_rook_moves,
            enemy_pieces, king_checking_squares);
    }
...
void MoveGenerator::generate_bishop_moves(MoveList& moves, const Position& pos, Color own_color, const Bitboard& pinned_info, Bitboard remedy_mask) {
    ...
    Bitboard king_checking_squares = 0;
    if constexpr (captures_only && with_checks) {
        king_checking_squares = bishop_attacks(pos.get_king_square(other_color), occupied) & ~own_pieces;
    }
    ...
    while (bishops) {
        ...
        append_piece_moves<captures_only, with_checks>(moves, pos, bishop_sq,
            PieceType::Bishop, own_color, other_color, possible_bishop_moves,
            enemy_pieces, king_checking_squares);
    }
...
void MoveGenerator::generate_knight_moves(MoveList& moves, const Position& pos, Color own_color, const Bitboard& pinned_info, Bitboard remedy_mask) {
    ...
    Bitboard king_checking_squares = 0;
    if constexpr (captures_only && with_checks) {
        king_checking_squares = knight_attacks(pos.get_king_square(other_color)) & ~own_pieces;
    }
    ...
    while (knights) {
        ...
        append_piece_moves<captures_only, with_checks>(moves, pos, knight_sq,
            PieceType::Knight, own_color, other_color, possible_knight_moves,
            enemy_pieces, king_checking_squares);
    }
